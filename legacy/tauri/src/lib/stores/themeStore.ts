...
export const THEMES_FILE =
  'C:\\Users\\ethan\\OneDrive\\Documents\\Church Presenter\\themes\\themes.json';
let themesStorePromise: ReturnType<typeof load> | null = null;

export const getThemesStore = () => {
  if (!themesStorePromise) {
    themesStorePromise = load(THEMES_FILE, {
      defaults: { themes: [] },
      autoSave: false,
    });
  }

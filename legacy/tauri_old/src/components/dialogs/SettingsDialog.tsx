                ...
                <div className="divide-y rounded-md border bg-card/50">
                  <div className="flex flex-col gap-3 px-4 py-3 sm:flex-row sm:items-start sm:justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Libraries, playlists, presentations, and media are stored here. Paths must stay
                        under this repository&apos;s <code className="text-xs">legacy/tauri_old/content</code>{' '}
                        tree (not your Documents folder).
                      </p>
                    </div>

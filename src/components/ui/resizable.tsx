...
// In react-resizable-panels v4.x, numeric values are pixels, not percentages.
// This helper converts numeric values to percentage strings for backward compatibility.
